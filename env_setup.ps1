...
Function lockBranch([string]$repo, [string]$branch){
  $uri = "https://api.github.com/repos/xxxxxx/$($repo)/branches/$($branch)/protection";
  $github_auth = [System.Convert]::ToBase64String([System.Text.Encoding]::ASCII.GetBytes("xxxxxx-ci:6a6fe7cc77284ebbcc54b05617748832946500ee"));
  $users = @();
